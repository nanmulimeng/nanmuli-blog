...
VALUES
    ...
    ('crawler.ai.model', 'deepseek-chat', 'qwen-plus', 'AI模型名称', 'crawler', FALSE, 'text', FALSE, FALSE),
...
FROM (VALUES
    ...
    ('crawler.ai.model', 'deepseek-chat', 'AI模型名称', 'crawler', FALSE, FALSE, 'text', 'qwen-plus'),
    ...
    ('crawler.optimization.mode', 'both', '优化模式(keyword/digest/both)', 'crawler', FALSE, FALSE, 'text', 'both'),
    ('crawler.optimization.target_score', '0.7', '优化目标分数', 'crawler', FALSE, FALSE, 'text', '0.7'),
    ('crawler.digest.filter_min_content', '50', '日报质量过滤最低字符数', 'crawler', FALSE, FALSE, 'text', '50'),
    ('crawler.digest.optimization_enabled', 'false', '日报优化独立开关', 'crawler', FALSE, FALSE, 'switch', 'false'),
    ('crawler.digest.optimization_min_sections', '2', '触发优化最少板块数', 'crawler', FALSE, FALSE, 'text', '2'),
    ('crawler.digest.optimization_target_score', '0.65', '日报优化目标分', 'crawler', FALSE, FALSE, 'text', '0.65'),
    ('crawler.pipeline.ai_organization_enabled', 'true', 'AI整理开关', 'crawler', FALSE, FALSE, 'switch', 'true'),
    ('crawler.pipeline.content_dedup_deep_threshold', '3', '深度爬取去重汉明距离', 'crawler', FALSE, FALSE, 'text', '3'),
    ('crawler.pipeline.content_dedup_enabled', 'true', '内容去重开关', 'crawler', FALSE, FALSE, 'switch', 'true'),
    ('crawler.pipeline.content_dedup_simhash_threshold', '5', '去重汉明距离阈值', 'crawler', FALSE, FALSE, 'text', '5'),
    ('crawler.pipeline.filter_deep_min_content', '20', '深度爬取最小内容长度', 'crawler', FALSE, FALSE, 'text', '20'),
    ('crawler.pipeline.filter_skip_header_chars', '200', '去重指纹跳过头部字符数', 'crawler', FALSE, FALSE, 'text', '200'),
    ('crawler.pipeline.page_classifier_enabled', 'true', '页面分类器开关', 'crawler', FALSE, FALSE, 'switch', 'true'),
